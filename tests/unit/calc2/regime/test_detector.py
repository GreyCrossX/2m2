...
def test_regime_detector_long_when_price_below_ma20_and_ma20_above_ma200() -> None:
...
def test_regime_detector_short_when_price_above_ma20_and_ma20_below_ma200() -> None:
    detector = RegimeDetector()
