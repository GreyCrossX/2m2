    ...
    def decide(
        ...
        *,
        ...
        if ma20 is None or ma200 is None:
            logger.debug(
                "Regime neutral (missing data) | ma20=%s ma200=%s",
                ma20, ma200
            )
        ...
        if (self._last_regime is not None) and (self._last_regime != regime):
            logger.info(
                ...
                self._last_regime, regime, ma20, ma200, close_for_long, close_for_short
            )
