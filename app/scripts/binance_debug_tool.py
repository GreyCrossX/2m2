...
API_KEY = os.getenv(
    "TESTNET_API_KEY",
    "6e39984cba7dc317232d9510d6b06a1aab59703720637e1e1d79608cfe5e8d69",
)
API_SECRET = os.getenv(
    "TESTNET_API_SECRET",
    "1a54fe2c45931502505d8bc6ebd983be2fe1165bacfc8b9d33a50f68e5751bf4",
)
                ...
                if isinstance(balance_data, list):
                    ...
                    for asset in balance_data:
                        if float(asset.get("balance", 0)) > 0:
                            print(
                                f"  {asset.get('asset')}: {asset.get('balance')} (available: {asset.get('availableBalance')})"
                            )
                else:
